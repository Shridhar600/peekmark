...
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [Main App Dark Mode](Assets/SCR-20260524-rkfa.jpeg) *Rich markdown rendering with metadata HUD* | [Quick Look Light Mode](Assets/SCR-20260524-rkzy.jpeg) *Instant preview by pressing Space in Finder* |



| ⚙️ Typography & Smooth Resizing                                                                                          | 💻 Code Action Overlays                                                                         |
| ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| [Typography Controls](Assets/SCR-20260524-rltk.png) *Adjust font face, size, and line spacing without losing your place* | [Code Actions](Assets/SCR-20260524-rmfr.png) *Word wrap toggles and copy-to-clipboard on hover* |
