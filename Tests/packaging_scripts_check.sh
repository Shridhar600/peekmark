...
grep -q "forbidden entitlement found" "$ROOT_DIR/script/install.sh"
grep -q 'verify_clean_entitlements "$APP_PATH" true true' "$ROOT_DIR/script/install.sh"
grep -q "codesign" "$ROOT_DIR/script/verify_install.sh"
grep -q "Assets.car" "$ROOT_DIR/script/verify_install.sh"
grep -q "Forbidden entitlement found" "$ROOT_DIR/script/verify_install.sh"
...
grep -q "forbidden entitlement found" "$ROOT_DIR/script/package_release.sh"
